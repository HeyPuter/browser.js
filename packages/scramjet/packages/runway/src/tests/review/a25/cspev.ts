...
runTest(async () => {
	...
	const m = document.createElement("meta"); m.httpEquiv = "Content-Security-Policy"; m.content = "img-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' 'report-sample'"; document.head.append(m);
