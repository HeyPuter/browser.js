// Ported from htmlparser2 v12.0.0 (src/Parser.spec.ts). Apart from the
// imports, the one change is the removal of "should support custom tokenizer":
// the `Tokenizer` option it tests was dropped from the vendored parser.
import { describe, expect, it, vi } from "vitest";
import { type Handler, Parser } from "../../src/shared/htmlparser/Parser";
