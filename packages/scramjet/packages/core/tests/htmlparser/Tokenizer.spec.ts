// Ported from htmlparser2 v12.0.0 (src/Tokenizer.spec.ts), unchanged apart
// from the imports. The snapshot file is upstream's, verbatim.
import { describe, expect, it } from "vitest";
import Tokenizer, {
    type Callbacks,
} from "../../src/shared/htmlparser/Tokenizer";
